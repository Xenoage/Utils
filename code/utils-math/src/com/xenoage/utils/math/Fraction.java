	...
	implements Comparable<Fraction>
{
	...
	public Fraction add(Fraction fraction)
	{
		if (fraction == null)
			return this;
		int numerator = this.numerator * fraction.denominator + this.denominator
			* fraction.numerator;
	...
	{
		return fr(this.numerator * fraction.denominator, this.denominator
			* fraction.numerator);
	}
	...
	{
		return fr(this.numerator * fraction.numerator, this.denominator
