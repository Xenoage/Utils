	...
	extends JComboBox<FontStyleChooserComboBox.Item>
{
	...
	@Override public Dimension getPreferredSize()
	{
		...
		return new Dimension(super.getPreferredSize().width, new JComboBox<Item>().getPreferredSize().height);
	}
		...
		implements ListCellRenderer<Item>
	{
		...
		@Override public Component getListCellRendererComponent(JList<? extends Item> list,
