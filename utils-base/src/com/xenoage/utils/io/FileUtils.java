...
import com.xenoage.utils.base.OSUtils;
import com.xenoage.utils.base.OSUtils.OS;
...
public class FileUtils
{
  ...
  /**
   * Reads the given file without using the {@link IO} classes into a string and returns it.
   * If the file does not exist or there is another I/O error, null is returned.
   */
  public static String readFileNoIO(String filepath)
  {
    try
    {
      StringBuffer fileData = new StringBuffer(1024);
