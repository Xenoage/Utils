...
public class NotesFormats
 extends SupportedFormats<Notes> {
	...
	private FileFormat<Notes> getTextFormat() {
		return new FileFormat<Notes>("notestxt", "Notes Text", ".notestxt", new String[0],
			new NotesInput(), new NotesOutput());
	}
	
	
	@Override public FileFormat<Notes> getReadDefaultFormat() {
		return formats.get(0);
	}

	
	@Override public FileFormat<Notes> getWriteDefaultFormat() {
		return formats.get(0);
	}
