...
import static com.xenoage.utils.graphics.color.ColorUtils.getColor;
import static com.xenoage.utils.graphics.color.ColorUtils.getHex;
import static com.xenoage.utils.graphics.color.ColorUtils.toHTMLColor;
...
import com.xenoage.utils.graphics.color.ColorUtils;
...
public class ColorUtilsTest
{
	...
	{
		ColorInfo c = new ColorInfo(0, 0, 1, 0);
		assertEquals(c, getColor("#00000001"));
		c = new ColorInfo(0, 0, 1, 0xFF);
		assertEquals(c, getColor("#FF000001"));
		assertEquals(c, getColor("#000001"));
		c = new ColorInfo(0x21, 0x16, 0x0B, 0x2C);
